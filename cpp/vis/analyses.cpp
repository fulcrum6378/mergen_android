...
bool Analyses::isDeviceSuitable(VkPhysicalDevice dev) {
    ...
    return indices.isComplete() && extensionsSupported && swapChainAdequate
           && deviceFeatures.wideLines == VK_TRUE; // not supported by any
}
...
void Analyses::createGraphicsPipeline(AAssetManager *assets) {
    ...
    inputAssembly.topology = VK_PRIMITIVE_TOPOLOGY_LINE_STRIP; // VK_PRIMITIVE_TOPOLOGY_LINE_LIST
    // https://web.engr.oregonstate.edu/~mjb/vulkan/Handouts/VertexBuffers.6pp.pdf
